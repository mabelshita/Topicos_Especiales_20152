...
def readfile(filename):  #####................lee los datos de un archivo de texto
  ...
  return rownames,colnames,data    ######.......... k palabras etan utilizando


from math import sqrt

def euclidean(v1,v2):   #####...........solo para 2 vectores 
  return sqrt(sum([(v1[i]-v2[i])**2 for i in range(len(v1))]))
  
def manhatan(v1,v2):   #####...........solo para 2 vectores 
...
class bicluster: ######............funciona como el nodo de los arboles
  def __init__(self,vec,left=None,right=None,distance=0.0,id=None):  ###...el contructor siempre se llama _init_
    self.left=left
    self.right=right   ##.....representa un objeto
    self.vec=vec
    self.id=id
    self.distance=distance

def hcluster(rows,distance=pearson):  ###.clustering jerarquico  
  distances={}
  currentclustid=-1

  # Los clusters son inicialmente las filas
  clust=[bicluster(rows[i],id=i) for i in range(len(rows))]  ###cluster = a una lista (bi..nodo)
...
def kcluster(rows,distance=pearson,k=4):  ###  luster asociativo.......
